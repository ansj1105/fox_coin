...
CREATE INDEX IF NOT EXISTS idx_offline_pay_shared_details_user_id
    ON offline_pay_shared_details (user_id);

CREATE INDEX IF NOT EXISTS idx_offline_pay_shared_details_expires_at
    ON offline_pay_shared_details (expires_at);
